...
def developer_instructions(
    *,
    ...
    exploration_discipline = (
        ...
        "requested test rather than continuing raw ADB exploration. When using the advertised "
        "platform source-only PoC builder, create and verify only "
...
def investigation_prompt(
    ...
    *,
    ...
    return (
        ...
        "only to resolve the ID of a target already named by a concrete discovered edge, never as "
        "a browsing list. Such an edge target may be examined and, when marked "
