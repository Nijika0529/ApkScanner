...
def developer_instructions(
    *,
    ...
    exploration_discipline = (
        ...
        "capture, move directly to one platform-managed PoC instead of searching logcat for an "
        "observation the target does not emit. After creating and verifying that PoC, return the "
        "requested test rather than continuing raw ADB exploration. "
    ...
    *,
    ...
    if direct_tool_access and shell_access and workspace_write:
        access_instruction = (
            ...
            "the manifest and Java source, return the request and let the advertised platform "
