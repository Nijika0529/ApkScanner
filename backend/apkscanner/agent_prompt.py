...
def investigation_prompt(
    ...
    *,
    ...
    return (
        ...
        "build a dedicated ordinary-app PoC and submit it through the live proof command. Android "
        ...
        "becomes platform harm evidence; use impact=none. target_uid_log_contains may use "
