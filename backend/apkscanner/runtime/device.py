...
from ..core.schemas import AgentOracleSpec, AgentPocSpec
                ...
                while True:
                    ...
                    for candidate in sorted(self._queue):
                        ...
                        if preferred in available_serials:
                            ...
                            break
                        if available_serials and (
                            preferred is None
                            or preferred not in self._serials
                            or preferred in self._draining
                        ):
                            selected_waiter = candidate
...
class AdbDeviceAdapter:
    ...
    def _dismiss_oem_jump_prompt(
        self,
        *,
        budget: TimeBudget | None = None,
    ) -> dict[str, Any]:
        """Detect and auto-dismiss the Vivo app jump prompt (AppJumpPromptActivity / 应用跳转提示).
                    ...
                    if oem_dismiss.get("detected"):
                        ...
                        commands.append(
                            (
                                ...
                                oem_dismiss.get("result", CommandResult([], -1, "", "")),
                                {
                                    **common,
