...
source_dir="$script_dir/specialcases-src"
unsigned_apk="$script_dir/specialcases-unsigned.apk"
aligned_apk="$script_dir/specialcases-aligned.apk"
output_apk="$script_dir/specialcases.apk"
