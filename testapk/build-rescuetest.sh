...
source_dir="$script_dir/rescuetest-src"
unsigned_apk="$script_dir/rescuetest-unsigned.apk"
aligned_apk="$script_dir/rescuetest-aligned.apk"
output_apk="$script_dir/rescuetest.apk"
